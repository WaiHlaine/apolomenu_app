...
import { useEditOrderItemsStore } from '@/store/cashier/useEditOrderItemsStore';
...
import { ImageOffIcon, Minus, Pen, Plus, PlusIcon } from 'lucide-react';
...
import PreviouslyOrderedItems from './PreviouslyOrderedItems';
...
export default function EditOrderDialog() {
    ...
    const clearOrders = useEditOrderItemsStore((store) => store.clearOrder);
    const firstOrder = tableOrders[0];
    // const previousOrders = tableOrders.map(order => {})
